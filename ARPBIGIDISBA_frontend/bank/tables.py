...
class SampleTable(tables.Table):
    class Meta:
        ...
        fields = ('id', 'species', 'name', 'strain', 'clone','description', 'rack', 'rack_col', 'rack_row','box', 'box_col', 'box_row', )
        attrs = {"id": "sample-table", 'class': 'table table-dark table-striped table-hover table-responsive results'}
        row_attrs = {
