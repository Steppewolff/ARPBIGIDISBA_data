...
class Mic(models.Model):
    ...
    pip_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Piperacillin clinical category", help_text="PIP-ARO:0000078 clinical category", db_comment='Categoría clínica de resistencia del aislado a piperacilina')
    ...
    pip_tz_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Piperacillin/Tazobactam clinical category", help_text="PIP/TZ-ARO:3004021 clinical category", db_comment='Categoría clínica de resistencia del aislado a piperacilina/tazobactam')
    ...
    fep_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Cefepime clinical category", help_text="FEP-ARO:0000059 clinical category", db_comment='Categoría clínica de resistencia del aislado a cefepima')
    ...
    cfdc_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Cefiderocol clinical category", help_text="FDC-ARO:3004474 clinical category", db_comment='Categoría clínica de resistencia del aislado a cefiderocol')
    ...
    caz_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ceftazidime clinical category", help_text="CAZ-ARO:0000060 clinical category", db_comment='Categoría clínica de resistencia del aislado a ceftazidima')
    ...
    caz_avi_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ceftazidime/Avibactam clinical category", help_text="CAZ/AVI-ARO:3007072 clinical category", db_comment='Categoría clínica de resistencia del aislado a ceftazidima/avibactam')
    ...
    tol_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ceftolozane clinical category", help_text="TOL-ARO:3003927 clinical category", db_comment='Categoría clínica de resistencia del aislado a tebipenem pivoxil')
    ...
    ctz_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ceftolozane/Tazobactam clinical category", help_text="TOL/TZ-ARO:3004724 clinical category", db_comment='Categoría clínica de resistencia del aislado a ceftolozano')
    ...
    imi_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Imipenem clinical category", help_text="IMI-ARO:3000170 clinical category", db_comment='Categoría clínica de resistencia del aislado a imipenem')
    #*********************************************************************************************************************************************************
    ...
    imi_rel_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Imipenem/Relebactam clinical category", help_text="IMI/REL-ARO:???????? clinical category", db_comment='Categoría clínica de resistencia del aislado a imipenem/relebactam')
    ...
    mer_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Meropenem clinical category", help_text="MER-ARO:0000073 clinical category", db_comment='Categoría clínica de resistencia del aislado a meropenem')
    ...
    mer_vab_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Meropenem/Vaborbactam clinical category", help_text="MER/VAB-ARO:3007146 clinical category", db_comment='Categoría clínica de resistencia del aislado a meropenem/vaborbactam')
    ...
    atm_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Aztreonam clinical category", help_text="AZT-ARO:3000550 clinical category", db_comment='Categoría clínica de resistencia del aislado a aztreonam')
    ...
    avi_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Avibactam clinical category", help_text="AVI-ARO:3000588 clinical category", db_comment='Categoría clínica de resistencia del aislado a avibactam')
    ...
    rel_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Relebactam clinical category", help_text="REL-ARO:3007031 clinical category", db_comment='Categoría clínica de resistencia del aislado a relebactam')
    ...
    azt_avi_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Aztreonam/Avibactam clinical category", help_text="AZT/AVI-ARO:3007366 clinical category", db_comment='Categoría clínica de resistencia del aislado a aztreonam/avibactam')
    ...
    cip_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ciprofloxacin clinical category", help_text="CIP-ARO:0000036 clinical category", db_comment='Categoría clínica de resistencia del aislado a ciprofloxacino')
    ...
    dlx_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Delafloxacin clinical category", help_text="DLX-ARO:3004462 clinical category", db_comment='Categoría clínica de resistencia del aislado a delafloxacino')
    ...
    lvx_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Levofloxacin clinical category", help_text="LVX-ARO:0000071 clinical category", db_comment='Categoría clínica de resistencia del aislado a levofloxacino')
    ...
    mxl_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Moxifloxacin clinical category", help_text="MXL-ARO:0000074 clinical category", db_comment='Categoría clínica de resistencia del aislado a moxifloxacino')
    ...
    ami_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Amikacin clinical category", help_text="AMI-ARO:0000013 clinical category", db_comment='Categoría clínica de resistencia del aislado a amikacina')
    ...
    gen_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Gentamycin clinical category", help_text="GEN-ARO:3007382 clinical category", db_comment='Categoría clínica de resistencia del aislado a gentamicina')
    ...
    net_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Netilmycin clinical category", help_text="NET-ARO:0000038 clinical category", db_comment='Categoría clínica de resistencia del aislado a netilmicina')
    ...
    tob_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Tobramycin clinical category", help_text="TOB-ARO:0000052 clinical category", db_comment='Categoría clínica de resistencia del aislado a tobramicina')
    ...
    col_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Colistin clinical category", help_text="COL-ARO:0000067 clinical category", db_comment='Categoría clínica de resistencia del aislado a colistina')
    ...
    fo_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Fosfomycin clinical category", help_text="FOS-ARO:0000025 clinical category", db_comment='Categoría clínica de resistencia del aislado a fosfomicina')
    ...
    tic_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Ticarcillin clinical category", help_text="TIC-ARO:3003832 clinical category", db_comment='Categoría clínica de resistencia del aislado a ticarcilina')
    ...
    taz_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Tazobactam clinical category", help_text="TZ-ARO:0000077 clinical category", db_comment='Categoría clínica de resistencia del aislado a tazobactam')
    ...
    nac_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Nacubactam clinical category", help_text="NAC-ARO:3007295 clinical category", db_comment='Categoría clínica de resistencia del aislado a nacubactam')
    ...
    dur_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Durlobactam clinical category", help_text="DUR-ARO:3007293 clinical category", db_comment='Categoría clínica de resistencia del aislado a durlobactam')
    ...
    xer_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Xeruborbactam clinical category", help_text="XER-ARO:3007048 clinical category", db_comment='Categoría clínica de resistencia del aislado a xeruborbactam')
    ...
    fep_tan_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Cefepime/Taniborbactam clinical category", help_text="FEP_TAN-ARO:3007148 clinical category", db_comment='Categoría clínica de resistencia del aislado a cefepime/taniborbactam')
    ...
    fep_zid_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Cefepime/Zidebactam clinical category", help_text="FEP_ZID-ARO:??????? clinical category", db_comment='Categoría clínica de resistencia del aislado a cefepime/zidebactam')
    ...
    fdc_xer_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Cefiderocol/Xeruborbactam clinical category", help_text="FDC_XER-ARO:???????? clinical category", db_comment='Categoría clínica de resistencia del aislado a cefiderocol/xeruborbactam')
    ...
    mer_nac_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Meropenem/Nacubactam clinical category", help_text="MER_NAC-ARO:???????? clinical category", db_comment='Categoría clínica de resistencia del aislado a meropenem/nacubactam')
    ...
    mer_xer_clinical_category = models.CharField(max_length=3, blank=True, null=True, choices=SIR_OPTIONS, verbose_name="Meropenem/Xeruborbactam clinical category", help_text="MER_XER-ARO:???????? clinical category", db_comment='Categoría clínica de resistencia del aislado a meropenem/xeruborbactam')
