...
class Mic(models.Model):
    ...
    isolate_id = models.OneToOneField(MetadataGeneral, models.DO_NOTHING, blank=True, null=True, db_column='isolate_id')
    pip = models.CharField(max_length=10, blank=True, null=True, verbose_name="Piperacilina")
    pip_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    pip_tz = models.CharField(max_length=10, blank=True, null=True, verbose_name="Piperacilina/Tazobactam")
    pip_tz_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    fep = models.CharField(max_length=10, blank=True, null=True, verbose_name="Cefepima")
    fep_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    cfdc = models.CharField(max_length=10, blank=True, null=True, verbose_name="Cefiderocol")
    cfdc_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    caz = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ceftazidima")
    caz_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    caz_avi = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ceftazidima/Avibactam")
    caz_avi_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    ctz = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ceftolozano")
    ctz_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    imi = models.CharField(max_length=10, blank=True, null=True, verbose_name="Imipenem")
    imi_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    imi_rel = models.CharField(max_length=10, blank=True, null=True, verbose_name="Imipenem/Relebactam")
    imi_rel_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    mer = models.CharField(max_length=10, blank=True, null=True, verbose_name="Meropenem")
    mer_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    mer_vab = models.CharField(max_length=10, blank=True, null=True, verbose_name="Meropenem/Vaborbactam")
    mer_vab_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    azt = models.CharField(max_length=10, blank=True, null=True, verbose_name="Aztreonam")
    azt_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    azt_avi = models.CharField(max_length=10, blank=True, null=True, verbose_name="Aztreonam/Avibactam")
    azt_avi_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    cip = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ciprofloxacino")
    cip_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    dlx = models.CharField(max_length=10, blank=True, null=True, verbose_name="Delafloxacino")
    dlx_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    lvx = models.CharField(max_length=10, blank=True, null=True, verbose_name="Levofloxacino")
    lvx_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    mxl = models.CharField(max_length=10, blank=True, null=True, verbose_name="Moxifloxacino")
    mxl_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    ami = models.CharField(max_length=10, blank=True, null=True, verbose_name="Amikacina")
    ami_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    gen = models.CharField(max_length=10, blank=True, null=True, verbose_name="Gentamicina")
    gen_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    net = models.CharField(max_length=10, blank=True, null=True, verbose_name="Netilmicina")
    net_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    tob = models.CharField(max_length=10, blank=True, null=True, verbose_name="Tobramicina")
    tob_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    col = models.CharField(max_length=10, blank=True, null=True, verbose_name="Colistina")
    col_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    fo = models.CharField(max_length=10, blank=True, null=True, verbose_name="Fosfomicina")
    fo_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    tic = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ticarcilina")
    tic_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    ptz = models.CharField(max_length=10, blank=True, null=True, verbose_name="Piperacilina/Tazobactam")
    ptz_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    taz = models.CharField(max_length=10, blank=True, null=True, verbose_name="Tazobactam")
    taz_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    cza = models.CharField(max_length=10, blank=True, null=True, verbose_name="Ceftazidima/Avibactam")
    cza_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    tol = models.CharField(max_length=10, blank=True, null=True, verbose_name="Tebipenem pivoxil")
    tol_clinical_category = models.CharField(max_length=2, blank=True, null=True)
    atm = models.CharField(max_length=10, blank=True, null=True, verbose_name="Aztreonam")
